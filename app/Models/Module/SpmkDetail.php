...
class SpmkDetail extends Model
{
	protected $table = "spmk_detail";
	public $timestamps = true;
	protected $primaryKey = 'id';
	protected $foreignKey = 'spmk_header_id';
  ...
  public function spmkHeader()
  {
    return $this->belongsTo('App\Models\Module\SpmkHeader','spmk_header_id','id');
  }
